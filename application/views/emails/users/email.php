...
This email confirms that your email address userd on {site_anchor} has been successfully changed.
 ...
 */
echo apply_filters('email_users_email_changed', $message, $lang);
