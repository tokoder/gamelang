...
|--------------------------------------------------------------------------
*/
$encryption_path_dist = APPPATH.'config/'.ENVIRONMENT.DIRECTORY_SEPARATOR.'encryption_key.php.dist';
$encryption_path = APPPATH.'config/'.ENVIRONMENT.DIRECTORY_SEPARATOR.'encryption_key.php';
