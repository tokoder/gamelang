 ...
 * @author		Tokoder Team
 */
class Gamelang_objects extends CI_Driver implements Gamelang_crud_interface
{
	/**
	...
	{
		log_message('info', 'Gamelang_objects Class Initialized');
	}
	...
	public function create(array $data = array())
	{
		...
		{
			$object['content'] = html_escape($object['content']);
		}
	...
	public function get_by($field, $match = null)
	{
		...
		if ($db_object)
		{
			$object = new CG_Object($db_object);
		}
	...
	public function get_many($field = null, $match = null, $limit = 0, $offset = 0)
	{
		...
		if ($db_objects)
		{
			...
			{
				$objects[] = new CG_Object($db_object);
			}
		}
...
if ( ! function_exists('add_object'))
{
	...
	{
		return get_instance()->objects->create($data);
	}
}
...
if ( ! function_exists('get_object'))
{
	...
	{
		return get_instance()->objects->get($id);
	}
}
...
if ( ! function_exists('get_object_by'))
{
	...
	{
		return get_instance()->objects->get_by($field, $match);
	}
}
...
if ( ! function_exists('get_objects'))
{
	...
	{
		return get_instance()->objects->get_many($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('get_all_objects'))
{
	...
	{
		return get_instance()->objects->get_all($limit, $offset);
	}
}
...
if ( ! function_exists('find_objects'))
{
	...
	{
		return get_instance()->objects->find($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('update_object'))
{
	...
	{
		return get_instance()->objects->update($id, $data);
	}
}
...
if ( ! function_exists('update_object_by'))
{
	...
	function update_object_by()
	{
		return call_user_func_array(
			array(get_instance()->objects, 'update_by'),
			func_get_args()
		);
	}
}
...
if ( ! function_exists('delete_object'))
{
	...
	{
		return get_instance()->objects->delete($id);
	}
}
...
if ( ! function_exists('delete_object_by'))
{
	...
	{
		return get_instance()->objects->delete_by($field, $match);
	}
}
...
if ( ! function_exists('delete_objects'))
{
	...
	{
		return get_instance()->objects->delete_by($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('remove_object'))
{
	...
	{
		return get_instance()->objects->remove($id);
	}
}
...
if ( ! function_exists('remove_object_by'))
{
	...
	{
		return get_instance()->objects->remove_by($field, $match);
	}
}
...
if ( ! function_exists('restore_object'))
{
	...
	{
		return get_instance()->objects->restore($id);
	}
}
...
if ( ! function_exists('restore_object_by'))
{
	...
	{
		return get_instance()->objects->restore_by($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('count_objects'))
{
	...
	{
		return get_instance()->objects->count($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('purge_objects'))
{
	...
	{
		return get_instance()->objects->purge($limit, $offset);
	}
}
...
class CG_Object
{
	 ...
	 * Constructor.
	 *
	 * Retrieves the object data and passes it to CG_Object::init().
	 *
	 * @access 	public
