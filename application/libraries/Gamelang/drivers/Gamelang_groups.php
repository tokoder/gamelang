 ...
 * @author		Tokoder Team
 */
class Gamelang_groups extends CI_Driver implements Gamelang_crud_interface
{
	/**
	...
	{
		log_message('info', 'Gamelang_groups Class Initialized');
	}
...
if ( ! function_exists('add_group'))
{
	...
	{
		return get_instance()->groups->create($data);
	}
}
...
if ( ! function_exists('get_group'))
{
	...
	{
		return get_instance()->groups->get($id);
	}
}
...
if ( ! function_exists('get_group_by'))
{
	...
	{
		return get_instance()->groups->get_by($field, $match);
	}
}
...
if ( ! function_exists('get_groups'))
{
	...
	{
		return get_instance()->groups->get_many($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('get_all_groups'))
{
	...
	{
		return get_instance()->groups->get_all($limit, $offset);
	}
}
...
if ( ! function_exists('find_groups'))
{
	...
	{
		return get_instance()->groups->find($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('update_group'))
{
	...
	{
		return get_instance()->groups->update($id, $data);
	}
}
...
if ( ! function_exists('update_group_by'))
{
	...
	function update_group_by()
	{
		return call_user_func_array(
			array(get_instance()->groups, 'update_by'),
			func_get_args()
		);
	}
}
...
if ( ! function_exists('delete_group'))
{
	...
	{
		return get_instance()->groups->delete($id);
	}
}
...
if ( ! function_exists('delete_group_by'))
{
	...
	{
		return get_instance()->groups->delete_by($field, $match);
	}
}
...
if ( ! function_exists('delete_groups'))
{
	...
	{
		return get_instance()->groups->delete_by($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('remove_group'))
{
	...
	{
		return get_instance()->groups->remove($id);
	}
}
...
if ( ! function_exists('remove_group_by'))
{
	...
	{
		return get_instance()->groups->remove_by($field, $match);
	}
}
...
if ( ! function_exists('restore_group'))
{
	...
	{
		return get_instance()->groups->restore($id);
	}
}
...
if ( ! function_exists('restore_group_by'))
{
	...
	{
		return get_instance()->groups->restore_by($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('count_groups'))
{
	...
	{
		return get_instance()->groups->count($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('purge_groups'))
{
	...
	{
		return get_instance()->groups->purge($limit, $offset);
	}
}
...
class CG_Group
{
	 ...
	 * Constructor.
	 *
	 * Retrieves the group data and passes it to CG_Group::init().
	 *
	 * @access 	public
