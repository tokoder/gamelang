 ...
 * @author		Tokoder Team
 */
class Gamelang_entities extends CI_Driver implements Gamelang_crud_interface
{
	/**
	...
	{
		log_message('info', 'Gamelang_entities Class Initialized');
	}
	...
	{
		/**
		 * Ada beberapa hal yang perlu kita periksa:
	...
	public function get_by($field, $match = null)
	{
		...
		if ($db_entity)
		{
			$entity = new CG_Entity($db_entity);
		}
	...
	public function find($field, $match = null, $limit = 0, $offset = 0)
	{
		...
		if ($db_entities)
		{
			...
			{
				$entities[] = new CG_Entity($db_entity);
			}
		}
...
if ( ! function_exists('get_entities_ids'))
{
	...
	{
		return get_instance()->entities->get_ids($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('add_entity'))
{
	...
	{
		return get_instance()->entities->create($data);
	}
}
...
if ( ! function_exists('get_entity'))
{
	...
	{
		return get_instance()->entities->get($id);
	}
}
...
if ( ! function_exists('get_entity_by'))
{
	...
	{
		return get_instance()->entities->get_by($field, $match);
	}
}
...
if ( ! function_exists('get_entities'))
{
	...
	{
		return get_instance()->entities->get_many($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('find_entities'))
{
	...
	{
		return get_instance()->entities->find($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('update_entity'))
{
	...
	{
		return get_instance()->entities->update($id, $data);
	}
}
...
if ( ! function_exists('update_entity_by'))
{
	...
	function update_entity_by()
	{
		return call_user_func_array(
			array(get_instance()->entities, 'update_by'),
			func_get_args()
		);
	}
}
...
if ( ! function_exists('delete_entity'))
{
	...
	{
		return get_instance()->entities->delete($id);
	}
}
...
if ( ! function_exists('delete_entity_by'))
{
	...
	{
		return get_instance()->entities->delete_by($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('remove_entity'))
{
	...
	{
		return get_instance()->entities->remove($id);
	}
}
...
if ( ! function_exists('remove_entity_by'))
{
	...
	{
		return get_instance()->entities->remove_by($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('restore_entity'))
{
	...
	{
		return get_instance()->entities->restore($id);
	}
}
...
if ( ! function_exists('restore_entity_by'))
{
	...
	{
		return get_instance()->entities->restore_by($field, $match, $limit, $offset);
	}
}
...
if ( ! function_exists('count_entities'))
{
	...
	{
		return get_instance()->entities->count($field, $match, $limit, $offset);
	}
}
...
class CG_Entity
{
	 ...
	 * Constructor.
	 *
	 * Retrieves the entity data and passes it to CG_Entity::init().
	 *
	 * @access 	public
