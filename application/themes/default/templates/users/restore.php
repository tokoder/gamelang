<div class="row">
	<div class="col-xs-12 col-sm-6 col-sm-push-3 col-md-4 col-md-push-4">
		<h1 class="text-center"><?php _e('USERS_RESTORE_ACCOUNT') ?></h1>
		<div class="panel panel-default">
			<div class="panel-body">
				<p class="text-muted"><?php _e('USERS_RESTORE_tip') ?></p><br />
			...
			<div class="panel-footer">
					...
					<?php echo anchor('register', __('create_account'), 'class="btn btn-default pull-right"') ?>
			</div>
		</div>
	</div>
</div>
