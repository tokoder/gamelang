<div class="row">
	<div class="col-xs-12 col-sm-6 col-sm-push-3 col-md-4 col-md-push-4">
		<h1 class="text-center"><?php _e('lang_resend_link') ?></h1>
		<div class="panel panel-default">
			<div class="panel-body">
				<p class="text-muted"><?php _e('USERS_RESEND_tip') ?></p><br />
				<?php echo form_open('register/resend', 'role="form" id="resend"'), form_nonce('user-resend-link'); ?>
					<div class="form-group<?php echo form_error('identity') ? ' has-error' : '' ?>">
						<label for="identity" class=""><?php _e('lang_identity') ?></label>
				...
				<?php endif; ?>
					<button type="submit" class="btn btn-primary btn-block"><?php _e('lang_resend_link') ?></button>
				<?php echo form_close() ?>
			</div>
