		...
		<div class="pesanan-item card">
			...
			<div class="card-body">
				<div class="row m-lr-0">
					...
					<div class="col-md-4 f-sm-12 f-md-16">
						Waktu Pemesanan:<br /><span class="text-dark p-r-8 font-medium"><?php echo $this->setting->ubahTgl("d M Y H:i", $rx->tgl); ?> WIB</span>
					</div>
				</div>
			</div>
			<div class="card-footer">
				<div class="row">
					<div class="col-md-8">
						<?php if ($rx->status == 1) { ?>
							<span class="f-sm-12 f-md-14 color2">Menunggu konfirmasi No Resi dari admin</span>
						<?php } elseif ($rx->status == 2) { ?>
							<span class="f-sm-12 f-md-14 color1">Pesanan sedang dikemas</span>
						<?php } ?>
					</div>
