			...
			<div class="card-header">
				<div class="row p-b-30">
					...
					<div class="col-6 text-right">
						<a href="<?php echo site_url("account/order/detail?orderid=") . $rx->orderid; ?>" class="btn btn-sm btn-dark f-sm-12 f-md-14"><i class="fas fa-angle-double-right"></i> Rincian<span class="hidesmall"> Pesanan</span></a>
					</div>
				</div>
			</div>
			<div class="card-body">
				<div class="row m-lr-0">
					<div class="col-md-8 p-lr-0 m-b-10">
						...
						foreach ($trp->result() as $key) {
							...
							if ($no == 2) { ?>
								<div class="pb-2 show-product">
								<?php
							}
								?>
								<div class="row pb-2 m-lr-0 produk-item">
						...
						if ($no > 2) {
							?>
								...
								<div class="row p-b-10 p-r-10 m-lr-0">
					...
					<div class="col-md-4 f-sm-12 f-md-16">
						Waktu Pembatalan:<br />
						<span class="text-danger p-r-8 font-medium"><?php echo $this->setting->ubahTgl("d M Y H:i", $rx->selesai); ?> WIB</span>
					</div>
				</div>
			</div>
			<div class="card-footer">
				<div class="row">
					<div class="col-md-6 f-sm-12 f-md-16">
						<strong>Alasan Pembatalan:</strong><br />
						<span class="text-danger"><?php echo $rx->keterangan; ?></span>
					</div>
					<div class="col-md-2 m-b-14"></div>
					<div class="col-md-4 text-right">
						<h5 class="text-dark f-sm-12 f-md-14">Total Order &nbsp;<strong><span class="color1 font-bold text-right">Rp <?php echo $this->setting->formUang($rx->ongkir + $totalproduk); ?></span></strong></h5>
					</div>
				</div>
			</div>
		</div>
